...
#if CONTROL_BOARD_TYPE == CONTROL_BOARD_WLT_V202 || CONTROL_BOARD_TYPE == CONTROL_BOARD_JXD_JD385 || CONTROL_BOARD_TYPE == CONTROL_BOARD_JJRC_H6C
...
#if CONTROL_BOARD_TYPE == CONTROL_BOARD_WLT_V202 || CONTROL_BOARD_TYPE == CONTROL_BOARD_JXD_JD385 || CONTROL_BOARD_JJRC_H6C
