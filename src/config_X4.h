...
#define USERSETTINGS_CHECKBOXHEADFREE CHECKBOXMASKAUX1LOW
#define USERSETTINGS_CHECKBOXAUTOTHROTTLE CHECKBOXMASKAUX2LOW
#define USERSETTINGS_CHECKBOXSEMIACRO CHECKBOXMASKAUX3LOW
#define USERSETTINGS_CHECKBOXFULLACRO CHECKBOXMASKAUX4LOW
