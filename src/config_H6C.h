...
#define CONTROL_BOARD_TYPE CONTROL_BOARD_JJRC_H6C
...
//#define STICK_DISARM STICK_COMMAND_ROLL_LOW+STICK_COMMAND_PITCH_HIGH
...
//not getting data here yet.. dunno why, ground pad is funny
...
#define LED1 LED1_STATE			//0x01 OUTSIDE LED
#define LED2 LED2_STATE 	//0x02  TOP LED
...
//#define USERSETTINGS_CHECKBOXLEDTOGGLE CHECKBOXMASKAUX1HIGH
#define USERSETTINGS_CHECKBOXARM CHECKBOXMASKAUX2HIGH
...
#define USERSETTINGS_CHECKBOXHEADFREE CHECKBOXMASKAUX1HIGH
